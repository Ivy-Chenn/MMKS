...
1. Verify whether the RTK has been reinstalled.
...
- 1301 Charging station position has been changed

**Solution:**

1. Return the mower to the charging station and use the "Relocate Charging Station" function in the app.
2. Guide the user to place the charging station in a position with at least 90° of open sky view of the lawn.
...
- 1114 Connection path already exists
...
1. Confirm whether the firmware is the latest version.
...
- 1223 Unclear boundary
- 1188 Recorded data processing error
- 1315 Positioning lost

**Solution:**

1. Check that the charging station is installed with no obstructions within 1.5m in the front/left/right directions.
...
1. Confirm whether the firmware has been updated to the latest version.
...
- 1188 Map recording failed
- 1199 Map storage abnormal
